...
//     function computePiDigitsForWidth(containerWidth, fontSize) {
//         const avgCharWidth = fontSize * 0.6; // Estimate character width in pixels
//         return Math.ceil(containerWidth / avgCharWidth);
//     }
...
//     const fontSize = 24; // Same as CSS
//     const numDigits = computePiDigitsForWidth(containerWidth, fontSize);
//     piDigits += computePiDigit(numDigits);
//     console.log("Computed number of digits for container width:", numDigits);
...
//         scrollingText.textContent = piDigits.repeat(2); // Ensure enough text for smooth scrolling
//         scrollingText.style.animation = `scroll-left ${lineIndex === 0 ? 5 : 10}s linear infinite`;
//         scrollingText.style.top = `${lineIndex * 30}px`; // Adjust line spacing
//         return scrollingText;
//     }

//     for (let i = 0; i < lines; i++) {
//         let scrollingText = createScrollingText(i);
//         container.appendChild(scrollingText);
//         console.log("Added scrolling text for line", i);
//     }
// });
document.addEventListener("DOMContentLoaded", function () {
    console.log("DOM fully loaded and parsed");
